...
public class Spirit extends Enemy {
	...
	////атаки:
	// летает вокруг, разбрасыва€ энергию(0)
	// падает на пол (1)
	// создает шоковую волну (2)
	//// специальные:
	// после потери половины хп, кидает щит
	// после потери 3/4 хп, впадает в €рость
